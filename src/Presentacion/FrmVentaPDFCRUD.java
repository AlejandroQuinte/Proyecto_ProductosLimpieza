 ...
 * @author alequ
 */
public class FrmVentaPDFCRUD extends javax.swing.JDialog {
//atributos globales
    ...
    public FrmVentaPDFCRUD(java.awt.Frame parent, boolean modal) throws Exception {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
        this.setTitle("Facturacion Ventas");
        try {
            LimpiarTabla();
        } catch (Exception e) {
            throw e;
    ...
    //metodo para eliminar el dato seleccionado
        ...
        if (seleccionado) {
            if (!lista.isEmpty()) {
                ...
                try {
                    ...
                    Logger.getLogger(FrmVentaPDFCRUD.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
            seleccionado = false;
    ...
    public void CargarDatos(String[] datos) {
        ...
        txtNombreCliente.setText(datos[3]);
    ...
    private void CargarDatos() {
        ...
        if (!txtCodigo.getText().equals("")) {
            ...
            datosCarga.setNombreCliente(txtNombreCliente.getText());
        ...
        for (DatosPlanilla datos : lista) {
            ...
            filaObj[3] = datos.getNombreCliente();
    ...
    private void initComponents() {
        ...
        btnSelectVenta = new javax.swing.JButton();
        ...
        btnSelectVenta.setText("Seleccionar otra Venta");
        btnSelectVenta.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnSelectVentaActionPerformed(evt);
            }
        });
        ...
        jScrollPane3.setViewportView(txtNombreCliente);
    ...
    private void btnSelectVentaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelectVentaActionPerformed
        FrmBuscarVenta frmBuscar;
        try {
            frmBuscar = new FrmBuscarVenta(null, true);
    ...
    }//GEN-LAST:event_btnSelectVentaActionPerformed
    ...
    private void btnGenerarPDFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarPDFActionPerformed
        ...
        try {
            ...
            if (datosTabla.isEmpty()) {
                ...
                plantilla.crearPlantillaVenta(nombreArchivo, fechaPDF, datosTabla);
            }
    ...
    private void tblComprasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblComprasMouseClicked
        ...
        //si se selecciono seleccionad= true para poder revisar si un dato se selecciono y poder hacer la eliminacion despues de dandole al boton eliminar
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmVentaPDFCRUD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    FrmVentaPDFCRUD dialog = new FrmVentaPDFCRUD(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JButton btnSelectVenta;
